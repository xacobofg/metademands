...
//      }
   ...
   function viewTypeField($options) {
      ...
      if ((isset($params['check_value']) || $params['value'] == 'upload' || $params['value'] == 'text') && (in_array($params['value'], $allowed_types) || ($params["type"] === "dropdown"))) {
...
//               }
   ...
   static function showHiddenBlockDropdown($metademands_id, $selected_value, $idF, $display = true) {
      ...
      return Dropdown::showNumber('hidden_bloc[]', ['value' => $selected_value,
                                                           ...
                                                           'min'   => 0,
                                                           'max'   => 10]);
//      return Dropdown::showFromArray('hidden_bloc[]', $data, ['value' => $selected_value, 'display' => $display]);
   }
